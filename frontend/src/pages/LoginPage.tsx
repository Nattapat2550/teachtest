...
export default function LoginPage() {
 ...
 <div className="w-full max-w-md bg-canvas p-8 rounded-md shadow-xl border ">
 ...
 <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center bg-canvas border border-outline text-ink font-bold py-2 px-4 rounded-md hover:bg-canvas dark:hover:bg-gray-600 transition">
