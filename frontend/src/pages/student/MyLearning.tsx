...
export default function MyLearning() {
 ...
 {learnings.length === 0 ? (
 <p className="text-muted bg-canvas p-8 rounded-md shadow-sm">คุณยังไม่มีคอร์สเรียน</p>
 ) : (
 ...
 return (
 <div key={l.id} className="bg-canvas rounded-md shadow-sm border p-5 flex flex-col">
