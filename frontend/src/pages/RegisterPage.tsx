...
const RegisterPage = () => {
 ...
 <h2 className="text-2xl font-bold text-ink text-center mb-6">สร้างบัญชีใหม่</h2>
 ...
 className="w-full px-4 py-2 bg-canvas border border-outline rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition text-ink "
 />
 </div>
 ...
 <div className="grow border-t border-outline "></div>
 <span className="px-3 text-sm">หรือ</span>
 <div className="grow border-t border-outline "></div>
 </div>

 <button onClick={handleGoogle} className="w-full flex items-center justify-center gap-2 border-2 border-outline hover:bg-canvas dark:hover:bg-gray-700 text-ink font-semibold py-2.5 rounded-md transition-colors">
