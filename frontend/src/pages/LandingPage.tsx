    ...
    <div className="w-full min-h-screen bg-canvas  pb-20 transition-colors duration-300 overflow-x-hidden">
      ...
      <div className="relative pt-20 pb-16 md:pt-24 md:pb-20 flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center">
          ...
          <Link 
            to="/login" 
            className="flex-1 bg-white  border-2 border-gray-200  hover:border-primary dark:hover:border-primary text-gray-900  font-bold py-3 px-6 rounded-md shadow-sm transition-all text-center flex items-center justify-center"
          >
            เข้าสู่ระบบ
          </Link>
        </div>
      ...
      {carousels.length > 0 && (
        <div className="w-full px-6 lg:px-12 2xl:px-20 mt-4">
          <div className="relative w-full h-62.5 md:h-100 lg:h-112.5 rounded-md overflow-hidden shadow-xl bg-white  border border-gray-200 ">
            {carousels.map((c, idx) => (
              <div
                key={c.id}
      ...
      {documents.length > 0 && (
        <div className="w-full px-6 lg:px-12 2xl:px-20 mt-16 md:mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {documents.map(d => (
              <div key={d.id} className="group bg-white  rounded-md shadow-sm overflow-hidden border border-gray-200  flex flex-col h-full transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 hover:border-primary/30">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-xl font-black mb-4 text-gray-900  leading-snug line-clamp-2">{d.title}</h3>
