...
const ResetPasswordPage = () => {
 ...
 <input type="email" required value={email} onChange={(e) => setEmail(e.target.value.trim())} className="w-full px-4 py-2 bg-canvas border border-outline rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition text-ink " />
 </div>
 ...
 <input type="password" required value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full px-4 py-2 bg-canvas border border-outline rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition text-ink " />
 </div>
