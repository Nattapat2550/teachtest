...
export default function AppealsTab() {
 ...
 <thead>
 <tr className="bg-canvas border-b border-outline ">
 ...
 <tbody>
 {appeals.map((appeal) => (
 <tr key={appeal.id} className="border-b border-outline hover:bg-canvas dark:hover:bg-gray-800/50 transition">
 ...
 {appeals.length === 0 && (
 <tr><td colSpan={5} className="p-8 text-center text-muted font-medium">ไม่มีรายการคำร้อง</td></tr>
 )}
 </tbody>
 </table>
 </div>
