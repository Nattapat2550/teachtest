      ...
      {examQuestions.map((q, qIdx) => (
        <div key={qIdx} className="p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 transition-all">
          ...
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700">
            <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2">แนบรูปภาพหรือวิดีโอ (ถ้ามี)</label>
            ...
            <input 
               ...
               disabled={uploading}
              className="text-sm text-blue-800 dark:text-blue-300 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 cursor-pointer w-full transition-colors"
             />
          ...
          {q.question_type === 'multiple_choice' ? (
            <div className="space-y-3">
              <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2">ตัวเลือก (เลือกข้อที่ถูก)</label>
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2">คำตอบที่ถูกต้อง (ซ่อนได้)</label>
              <input 
                 type="text" 
