...
func (h *Handler) AdminUpdateGlobalPromo(w http.ResponseWriter, r *http.Request) {
	...
	_, err := h.TeachDB.Exec(`UPDATE promo_codes SET code=$1, discount_amount=$2, max_uses=$3, course_id=$4 WHERE id=$5`, req.Code, req.DiscountAmount, req.MaxUses, req.CourseId, id)
	if err != nil {
		h.writeError(w, http.StatusInternalServerError, "Update failed")
		return
	}
